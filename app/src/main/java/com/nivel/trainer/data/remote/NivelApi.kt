...
interface NivelApi {
    ...
    /**
     * Транскрипт сессии (#75, реальный роут NIVEL#223): статус обработки + сырой
     * текст + сегменты. Trainer-only, ownership на сервере. 404 — строки транскрипта
     * ещё нет (аудио не загружено/не расшифровано) — экран показывает пустое
     * состояние «запись ещё не расшифрована», не ошибку.
     */
